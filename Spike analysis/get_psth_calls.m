function [psth_tensor_onset, psth_tensor_offset,psth_edges_onset,psth_edges_offset, mean_rate_during_call, all_call_index, cluster_area, call_length, CallStats, call_type,calls_within,psth_calls_onset,behavior_type] = get_psth_calls(current_dir,behaviors2analyse,area2analyze,range_borders,psth_bin)
...
for j=1:numel(beh_indexes)
    ...
    these_calls = find(CallStats.BeginTimes>=beh_start+range_borders(1) & CallStats.BeginTimes<=beh_start+this_beh_length+range_borders(2));
